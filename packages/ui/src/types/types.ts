...
export type INode = {
  ...
  deltaArray?: Maybe<Array<Scalars["Int"]>>;
  host: IHost;
  id: Scalars["ID"];
...
export type IChainsQuery = {
  chains: Array<{ id: string; name: string; type: string; allowance?: number | null }>;
};
...
export type IGetHealthCheckQuery = {
  healthCheck: {
    node?: { status: string; conditions: string } | null;
    height?: {
