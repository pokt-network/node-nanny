...
const proccess =  {
  ...
  type: 'error',
  title: '[Triggered on {@blockchainID:0021,@serviceDomain:thunderstake.io,region:eu-south-1,service:eu-south-1/ecs/gateway}] High latency!',
  status: '',
  link: 'https://app.datadoghq.eu/event/event?id=6268218125651091624',
  tags: 'blockchainid:0021,critical,latency,monitor,region:eu-south-1,service:eu-south-1/ecs/gateway,servicedomain:thunderstake.io'
}
