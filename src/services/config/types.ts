...
export enum ExternalEndPoints {
  ...
  FUS = "/pocket/monitoring/config/externalEndpoints/fus",
  GOE = "/pocket/monitoring/config/externalEndpoints/goe",
  KOV = "/pocket/monitoring/config/externalEndpoints/kov",
  POL = "/pocket/monitoring/config/externalEndpoints/pol",
  RIN = "/pocket/monitoring/config/externalEndpoints/rin",
